...
// Laporan
Route::get('laporan', 'LaporanController@index')->name('laporan.index')->middleware('can:read-laporan');
Route::post('laporan', 'LaporanController@store')->name('laporan.store')->middleware('can:read-laporan');
