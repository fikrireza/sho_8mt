...
Route::group(['middleware' => ['administrator']], function () {
  ...
  Route::get('plafon/ubah/{jenis_plafon}/{jumlah_pembiayaan}', 'PlafonController@ubah')->name('plafon.ubah');
  Route::post('plafon/ubah/', 'PlafonController@edit')->name('plafon.edit');
  ...
  Route::get('iuran/tambah', 'IuranController@tambah')->name('iuran.tambah');
  ...
  // Klaim
  Route::get('klaim', 'KlaimController@index')->name('klaim.index');
  Route::post('klaim', 'KlaimController@check')->name('klaim.check');
  Route::post('klaim/store', 'KlaimController@store')->name('klaim.store');
